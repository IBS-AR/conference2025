...
sessions <- readRDS(here::here("book/data/sessions.rds")) |> 
  ...
  mutate(content = case_when(type %in% c("General", "Social") ~ titles,
                             str_trim(speakers) == "Chris Brien" ~ str_c("(CANCELLED) <b>", map_chr(titles, quarto::tbl_qmd_span), "</b> by <i>", speakers, "</i>", time, "<details><summary>Abstract</summary>", map_chr(abstract, quarto::tbl_qmd_span), "</details>"),
