...
## Outdoor tours cancelled

Due to weather warnings, the outdoors tours will be cancelled.
For those that registered for Tidbinbilla Nature Reserve, we will fully refund you.

Alternative indoor tours will be planned. We will announce this (via email or otherwise) before lunch time.
...
If you did not register for these in the conference registration, you can register for them separately [here](https://membership.biometricsociety.org.au/event-6193040).
