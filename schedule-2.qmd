    ...
    function openModal(eventId) {
        ...
        modalBody.innerHTML = `
            <div class="modal-section">
                <div class="modal-section-name">Instructor</div>
                <div class="modal-section-content">${event.speaker}</div>
            </div>
            <div class="modal-section">
                <div class="modal-section-name">Location</div>
                <div class="modal-section-content">${event.location}</div>
            </div>
            <div class="modal-section">
                <div class="modal-section-name">Level</div>
                <div class="modal-section-content">${event.level}</div>
            </div>
            <div class="modal-section">
                <div class="modal-section-name">Abstract</div>
                <div class="modal-section-content">${event.abstract}</div>
            </div>
            <div class="modal-section">
                <div class="modal-section-name">Description</div>
                <div class="modal-section-content">${event.description}</div>
            </div>
            <div class="modal-section">
                <div class="modal-section-name">Equipment</div>
                <div class="modal-section-content">${event.equipment}</div>
            </div>
        `;
