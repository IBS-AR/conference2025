...
/* Event type colors */
.general {
    background: linear-gradient(135deg, #6b7280, #4b5563); /* slate */
}

.keynote {
    background: linear-gradient(135deg, #d97706, #b45309); /* warm amber/gold */
}

.social {
    background: linear-gradient(135deg, #f472b6, #ec4899); /* soft magenta */
}
...
.poster {
    background: linear-gradient(135deg, #10b981, #059669); /* teal green */
}
...
div(class = "scroll-wrapper",
    ...
    legend(types = c("general", "social", "keynote", "invited", "poster", "talk", "workshop"),
           labels = c("General", "Social", "Keynote", "Invited", "Poster", "Talk", "Workshop"))
    )
)
