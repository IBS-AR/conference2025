...
[Register for<br>Generalized Nonlinear Models in R](https://membership.biometricsociety.org.au/event-6207949){.button-cta .cta-button}
...
[Register for<br>Analysing Complex Survey and Subsample Data (with R)](https://membership.biometricsociety.org.au/event-6244472){.button-cta .cta-button}
...
[Register for<br>Lost in Translation: Speaking Statistician in a Multi-Lingual World](https://membership.biometricsociety.org.au/event-6244474){.button-cta .cta-button}
